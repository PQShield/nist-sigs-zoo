 ...
 * that exceed the system default stack limit (e.g. code-based KEMs with big
 * key buffers on the stack).  setrlimit(RLIMIT_STACK) is ineffective when the
 * hard limit is capped; pthread stack size is independent of rlimit. */
