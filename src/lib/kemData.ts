 ...
 *
 * Unlike the signature pipeline this is a one-off size comparison: no versions,
 * no round tags, no benchmarks. Security flags (broken/warning/info) may be set
 * at scheme level and overridden per parameter set.
 */
